...
products.forEach(function(elem, i, products) {
...
const productsWithPhoto = products1.filter((products1) => {
    if ("photos" in products1 && products1.photos.length > 0) return true
    return false
});
